# Generated by Powerlevel10k configuration wizard on 2026-01-08 at 14:55 PST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Show git describe --always --long --abbrev=12 output if available (requires tags).
    local describe
    describe=$(git -C ${VCS_STATUS_WORKDIR} describe --always --long --tags --dirty --abbrev=12 2>/dev/null)
    [[ -n $describe ]] && res+=" ${meta}${describe//\%/%%}"
  ...
  # Show battery only when low. - added by AI, CHM
  typeset -g POWERLEVEL9K_BATTERY_SHOW_ON_AC=true
  typeset -g POWERLEVEL9K_BATTERY_SHOW_CHARGE=true
  #####################################[ wifi: wifi speed ]#####################################
  # WiFi color.
